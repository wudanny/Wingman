 ...
 * @author Danny
 */
public class Backward_Enemy_Plane extends Enemy_Mini {

    Backward_Enemy_Plane(Vector image, int x, int y, int health, int speed, int reward, int collidingDamage, GameEvents event) {
        this.image = image;
        this.x = x;
        this.y = y;
        this.health = health;
