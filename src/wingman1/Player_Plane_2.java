...
public class Player_Plane_2 extends Player_Plane {
    ...
    Player_Plane_2(Vector image, int x, int y, int speed, GameEvents event, int health, int gapBetweenFire, int life, int collidingDamage, int gapBetweenDeath, int heightBound, int widthBound) {
        this.image = image;
        this.x = x;
        this.y = y;
    ...
    public void update(Observable o, Object o1) {
        ...
        if (show || this.waitForSpawn == 0) {
            ...
            } else if (ge.getType() == 11 && ge.player instanceof Player_Plane_2) {
